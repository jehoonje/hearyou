...
const ChatMessage = memo<ChatMessageProps>(
  ({ message, isSender, senderProfile, onReport }) => {
    ...
    const bubbleClass = isSender
      ...
      : `${bubbleBaseStyle} ${receiverBubbleStyle}`;
    ...
    return (
      <>
        <div
          className={`flex flex-col mb-2 ${alignClass} relative`}
        ...
        >
          ...
          >
            ...
            <div className="relative group">
              ...
              >
                <p className={isShortMessage ? "" : "break-words"}>
...
{/* 
        ...
        {showReportModal && (
          ...
          >
            <div
              className="bg-gray-900/20 rounded-lg p-6 max-w-sm w-full"
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="sexual_content">
                      {t.chat.reportReasons.sexualContent}
                    </option>
